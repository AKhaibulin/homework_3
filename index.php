...
<html>
<head>
	<title>Продуктовый магазин "Радуга" </title>
...
<body style="padding-top:10px;">
	<?php
		$products = array(
			'0' => array('id'=>1,'name'=> 'молоко', 'price'=>60),
			'1'=>array('id'=>2,'name'=>'хлеб', 'price'=>20),
			'2'=>array('id'=>3,'name'=>'мясо (говядина)', 'price' =>200),
			'3'=>array('id'=>4,'name'=>'гипсовая фигурка', 'price'=>150),
			'4'=>array('id'=>5,'name'=>'масло подсолнечное','price'=>140),
			'5'=>array('id'=>6,'name'=>'рулет клубничнывй', 'price'=>100));
